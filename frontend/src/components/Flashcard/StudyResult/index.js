...
function StudyResult({ knownWords, unknownWords, onRestart, onReviewWrong, topicTitle }) {
    ...
    <div className={`container ${classes.wrapper}`}>
      ...
      <Box position="relative" display="inline-flex" my={3}>
        ...
        <Box
          ...
          <Typography className={classes.percentSub}>
            đã nhớ
          </Typography>
        </Box>
      </Box>
